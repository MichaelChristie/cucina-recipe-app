      ...
      <div className="relative h-[600px]">
        ...
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          <div className="relative z-50 w-full lg:w-1/2 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl py-8 text-gray-900 lg:px-8">
                ...
                <div className="mt-4">
                  <div className="relative">
                    <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none">
                      <PiCarrot className="h-5 w-5 text-gray-400" weight="light" />
                    </div>
                    <IngredientSearch
                      ...
                      className="w-full pl-10 pr-4 py-2 rounded-lg
                                bg-white/10 backdrop-blur-sm border-0
